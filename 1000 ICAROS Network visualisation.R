...
ego_gender[ego_gender == "NA"] = NA
ego_gender = drop_na(ego_gender)
...
ggsave(filename = "ICAROS figure 1.jpeg", plot = ICAROS_fig1, width = 10 ,height = 10)
