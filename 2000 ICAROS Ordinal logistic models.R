# ==========================================
# FILE:   04 Ordinal Logistic Regression models
...
sink(file = "_MCMCglmm_ord_/M0_output.txt")
summary(M0)
sink(file = NULL)
...
sink(file = "_MCMCglmm_ord_/M1_output.txt")
summary(M1)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M1_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M1$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M1_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M1$VCV))
dev.off()
...
write.table(M1_stargazer, file = "_MCMCglmm_ord_/M1.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
#write.table(M1, file = "_MCMCglmm_ord_/M1.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
sink(file = "_MCMCglmm_ord_/M2_output.txt")
summary(M2)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M2_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M2$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M2_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M2$VCV))
dev.off()
...
write.table(M2_stargazer, file = "_MCMCglmm_ord_/M2.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
sink(file = "_MCMCglmm_ord_/M3_output.txt")
summary(M3)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M3_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M3$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M3_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M3$VCV))
dev.off()
...
write.table(M3_stargazer, file = "_MCMCglmm_ord_/M3.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
sink(file = "_MCMCglmm_ord_/M4_output.txt")
summary(M4)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M4_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M4$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M4_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M4$VCV))
dev.off()
...
sink(file = "_MCMCglmm_ord_/M5_output.txt")
summary(M5)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M5_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M5$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M5_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M5$VCV))
dev.off()
...
sink(file = "_MCMCglmm_ord_/M6_output.txt")
summary(M6)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M6_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M6$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M6_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M6$VCV))
dev.off()
...
sink(file = "_MCMCglmm_ord_/M7_output.txt")
summary(M7)
sink(file = NULL)
...
## EXPORT OUTPUT 
pdf(file = "_MCMCglmm_ord_/M7_Sol.pdf", width = 5, height = 8)
plot(mcmc.list(M7$Sol))
dev.off()

pdf(file = "_MCMCglmm_ord_/M7_VCV.pdf", width = 8, height = 6)
plot(mcmc.list(M7$VCV))
dev.off()
...
save.image(file = 'MCMCglmm_ord_RESULTS.RData')